package com.example.juansaul.holamundoboton;
...
public class Holamundo extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_holamundo, menu);
        return true;
    }
...
// do something when the button is clicked
    ...
    public void MessageBox(String mensajeMostrar){
